                    ...
                    <CardContent className="flex flex-col ">
                        <Card className="p-24 max-w-lg"
                              style={{backgroundColor: 'rgba(0, 0, 0, 0)', boxShadow: 'none'}}>
                                ...
                                <p className="mt-3 font-sans text-lg pl-4 text-gray-600">Her kan du book personale til jeres arrangement</p>
                                <SubmitButton
                                    onClick={this.createBooking}
                                    className="min-w-160 min-h-48 mt-5"
                                    style={{color: "white"}}
                                >Book Personale</SubmitButton>
                            <Tabs className="mt-5" variant="scrollable" value={selectedTab} onChange={this.changeHandler}>
                                <Tab label="Beskeder"/>
