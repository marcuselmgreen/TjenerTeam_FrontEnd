    ...
    return (
        <Card className="pl-20 pr-20 pb-52 pt-10">
            ...
            <div className="flex mb-5">
                <div className="w-full">
                    <p className="text-base font-bold ">Hvilket niveau snakker og forstår du dansk?</p>
                </div>
            </div>
            ...
            <div className="flex">
                ...
                <div className="w-1/2">
                    <div className="flex justify-center">
                        <Button onClick={moveForward} disabled={user.languageSkillDanish === null}  className="submitButton">Næste</Button>
                    </div>
                </div>
            </div>
